...
function createOptions(passwordHash: string, repositories: ControlPlaneRepositories): StartAdminApiServerOptions {
  ...
  return Object.freeze({
    ...
    system: Object.freeze({
      adminVersion: '0.1.0-p5', mcpServerVersion: '0.1.0-p4', salesforceApiVersion: 'LATEST_PER_FRESH_CONNECTION',
      ...
      phases: Object.freeze({ P0: 'PASS', P1: 'PASS', P2: 'PASS', P3: 'PASS', P4: 'PARTIAL', P5: 'IN DEVELOPMENT' }),
    }),
