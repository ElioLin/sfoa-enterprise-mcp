...
For a lasting architecture, package, schema, command, deployment, or troubleshooting change, update the canonical Skill, run `yarn skill:sync`, `yarn skill:check`, and `yarn skill:test`, then update the project baseline/changelog/ADR when required.
