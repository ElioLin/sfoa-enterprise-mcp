...
| P7-04 captures Salesforce wire facts but not P7-05/P7-06 bodies | Treating URL/API evidence as structured SOQL/DML or MCP payload capture would overstate coverage | Salesforce API arrays are active and bounded; payload arrays remain empty until later reviewed phases |
